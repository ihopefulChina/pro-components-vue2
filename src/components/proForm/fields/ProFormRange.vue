  ...
  <ProFormItem :name="name" :label="label" :span="span" :required="required" :rules="rules" :tooltip="tooltip">
    <div class="pro-form-range">
      ...
      <div v-else-if="mode === 'select'" class="range-selects">
        <el-select v-model="startValue" :disabled="disabled" :placeholder="startPlaceholder" :size="size" @change="handleChange">
          <el-option v-for="option in options" :key="option.value" :label="option.label" :value="option.value" />
        </el-select>
        <span class="range-separator">{{ separator }}</span>
        <el-select v-model="endValue" :disabled="disabled" :placeholder="endPlaceholder" :size="size" @change="handleChange">
          <el-option v-for="option in options" :key="option.value" :label="option.label" :value="option.value" />
        </el-select>
      </div>
